...
int main() {
  ...
  srand(seed);
  printf("\nBoot from SBI to mini-kernel \n");
  printf("[opensbi-mle rvv test]: run matmul\n");
  ...
  print_array_2d(golden,N,M,"double","golden_2d");
  print_array_2d(actual,N,M,"double","golden_2d");
}
