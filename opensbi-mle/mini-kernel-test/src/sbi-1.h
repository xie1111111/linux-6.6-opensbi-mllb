...
static inline struct sbiret tensor_add(Tensor *dst, Tensor *src1, Tensor *src2){
    return sbi_ecall(SBI_EXT_ML,SBI_EXT_ML_TENSOR_ADD,(unsigned long)dst,(unsigned long)src1,(unsigned long)src2,0,0,0);
}

static inline struct sbiret tensor_sub(Tensor *dst, Tensor *src1, Tensor *src2){
    return sbi_ecall(SBI_EXT_ML,SBI_EXT_ML_TENSOR_SUB,(unsigned long)dst,(unsigned long)src1,(unsigned long)src2,0,0,0);
}
...
static inline struct sbiret tensor_relu(Tensor *dst, Tensor *src) {
    return sbi_ecall(SBI_EXT_ML, SBI_EXT_ML_RELU,(unsigned long)dst, (unsigned long)src,0, 0, 0, 0);
}
