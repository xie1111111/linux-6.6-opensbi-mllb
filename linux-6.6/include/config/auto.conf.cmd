...
ifneq "$(CC_VERSION_TEXT)" "riscv64-unknown-linux-gnu-gcc (g1b306039ac4) 15.1.0"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "riscv64-unknown-linux-gnu-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "riscv64-unknown-linux-gnu-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(PAHOLE)" "pahole"
include/config/auto.conf: FORCE
...
ifneq "$(AR)" "riscv64-unknown-linux-gnu-ar"
include/config/auto.conf: FORCE
endif
